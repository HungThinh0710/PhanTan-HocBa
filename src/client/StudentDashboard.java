...
//		        new FrmMain().setVisible(true);
				...
				.addGroup(gl_panel_right.createSequentialGroup()
					...
					.addGroup(gl_panel_right.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_right.createSequentialGroup()
							.addGroup(gl_panel_right.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_right.createSequentialGroup()
									.addComponent(lblaCh, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
									.addGap(18)
		...
		gl_panel_right.setVerticalGroup(
			gl_panel_right.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_panel_right.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panel_right.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_right.createSequentialGroup()
							.addGap(4)
					...
					.addGroup(gl_panel_right.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_right.createSequentialGroup()
							.addGap(3)
							.addComponent(lblaCh))
						.addComponent(txtAaddress, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_panel_right.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_right.createSequentialGroup()
							.addGap(3)
	...
	private void fillData() {
		...
		ArrayList <Student> userList = dasboardControl.getArrayListStudent();
